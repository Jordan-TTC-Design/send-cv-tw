...
export default {
  ...
  mounted() {
    ...
    emitter.on('open-uploadUserImgModal', this.emitOpenUserImgModal);
    emitter.on('close-uploadUserImgModal', this.emitCloseUserImgModal);
  ...
  unmounted() {
    ...
    emitter.off('open-uploadUserImgModal', this.emitOpenUserImgModal);
    emitter.off('close-uploadUserImgModal', this.emitCloseUserImgModal);
