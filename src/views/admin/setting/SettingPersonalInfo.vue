<template>
  <div class="adminPage--py">
    ...
    <div class="container-xl position-relative">
      <div class="row">
        <div class="col-lg-3 col-md-4" :class="{ 'rwdClose--sm': rwdSelect !== '' }">
          <div class="sideContentBox rwdSelectBox pb-3">
            <div class="sideContentBox__header personSetting">
              ...
              <div
                class="
                  btn btn--switch btn--switch--jobSeeker
                  w--100
                  border border-gray-line
                  rounded
                "
                @click="personalState = !personalState"
              >
                {{ personalState ? `開放求職中` : `已關閉求職` }}
                <div class="ms-2 switch__container" :class="{ active: personalState }">
            ...
            <ul class="innerList innerList--jobSeeker innerList--checkList">
              <li
                ...
                :class="{ active: mainContentList === '個人資料' }"
              >
              ...
              <li
                ...
                :class="{ active: mainContentList === '工作經驗' }"
              >
              ...
              <li
                ...
                :class="{ active: mainContentList === '教育程度' }"
              >
              ...
              <li
                ...
                :class="{ active: mainContentList === '專業技能' }"
              >
              ...
              <li
                ...
                :class="{ active: mainContentList === '其他' }"
              >
        ...
        <div class="col-lg-9 col-md-8" :class="{ 'rwdClose--sm': rwdSelect === '' }">
          <!-- 個人資訊 -->
          <div class="adminContentBox adminContentBox--full" v-if="mainContentList === '個人資料'">
            <div class="adminContentBox__body">
              ...
              <div class="flex-grow-1" v-if="!editMode">
              ...
              <div class="flex-grow-1" v-if="editTemplate === 'editPersonalData'">
                <Form
          ...
          <!-- 工作經驗 -->
          <div
            class="adminContentBox adminContentBox--full pb-3"
            v-if="mainContentList === '工作經驗'"
          >
            <div class="adminContentBox__body flex-grow-1">
          ...
          >
            <div class="adminContentBox__body flex-grow-1">
              ...
              <ul
                class="infoList infoList--jobSeeker infoList--withBtn infoList--row"
                v-if="skillShowStyle === true"
              >
                <!-- 語言 -->
                <li
                  ref="languageData"
                ...
                <!-- 證照 -->
                <li class="infoList__item" :class="{ 'd-none': editTemplate === 'editLicense' }">
                  <div>
          ...
          <!-- 其他 -->
          <div class="adminContentBox adminContentBox--full pb-3" v-if="mainContentList === '其他'">
            <div class="adminContentBox__body flex-grow-1">
...
export default {
  ...
  methods: {
    ...
    selectListItem(navName) {
      this.processSelectData(navName);
      this.closeTemplate();
    },
    backToList() {
