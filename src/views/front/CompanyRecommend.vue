  ...
  <div class="page--py">
    <div class="container-xl">
      <div class="sction--weeklyCompany section--pb">
        ...
        <div class="weeklyCompany" v-if="dataOk">
          <div class="row d-flex flex-lg-row flex-column gy-5">
            <div class="col-lg-3">
              <div class="weeklyCompany__infoBox">
                ...
                <div class="txtBox d-flex flex-column justify-content-between">
                  <router-link
                    class="pageTitle mb-3 putPointer"
            ...
            <div class="col-lg-9">
              <h5 class="pageSubTitle mb-3">公司簡介</h5>
              <div class="weeklyCompany__companyContentBox mb-5">
              ...
              <h5 class="pageSubTitle mb-3">現有職位</h5>
      ...
      <div class="section--aroundCompany section--pb" v-if="sortCompany.length > 0">
        ...
        <div class="row row-cols-xl-4 row-cols-md-2 row-cols-1 gy-md-4 gy-3">
        ...
        <div class="recommendCardList section--py">
          <div class="titleBox mb-5">
            ...
            <div class="recommendTagList">
              <button type="button" class="recommendTagList__btn btn btn-outline-gray-line active">
                根據個人興趣
              </button>
          ...
          <ul class="row row-cols-md-2 row-cols-1 gy-md-4 gy-3" v-if="sortCompany.length > 0">
            <template v-for="(companyItem, index) in sortCompany" :key="companyItem.id">
              <li class="col" v-if="index < recommendCardList">
                <div :ref="`list__item--${companyItem.id}`" class="list__item">
                  ...
                  <div class="list__item__jobBox w-100 putPointer">
                    ...
                    <div class="d-flex justify-content-between">
                      <p>48000 / 月薪</p>
                      <p class="subTxt--foil">2020/01/01</p>
                    </div>
                  </div>
                </div>
              </li>
    ...
    <div class="container-xl">
      <div class="section--py">
        <div class="titleBox justify-content-lg-start justify-content-center mb-5">
          <h3 class="titleBox__title">全部企業</h3>
        </div>
        <!-- 篩選條件 -->
        <div class="filterBox bg-white mb-lg-6 mb-4 rounded">
        ...
        <div
          class="row row-cols-xl-4 row-cols-lg-3 row-cols-md-2 row-cols-1 gy-4"
          v-if="sortCompany.length > 0"
        >
