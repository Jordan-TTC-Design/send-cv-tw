<template>
  <div class="page--py">
    <div class="container-xl jobPage" v-if="isExist">
      <div class="row">
        <div class="col-lg-9">
          <div class="jobContentBox jobInfoBox box--shadow mb-3 d-flex flex-lg-row flex-column">
            ...
            <div class="jobInfoBox__txtBox">
              <div class="mb-1">
                <p class="jobTag bg-primary me-2 text-dark">
                  <i class="jobIcon-sm bi bi-star-fill text-dark"></i>
                </p>
              ...
              <div class="d-flex justify-content-between align-items-end">
                ...
                <div>
                  <p class="strongTxt text-end mb-3" v-if="!jobItem.options.job.salaryInterView">
                    {{ jobItem.price }} / 月薪
                  </p>
                  <p class="strongTxt text-end mb-3" v-if="jobItem.options.job.salaryInterView">
                    薪資面議
        ...
        <div class="col-lg-3">
          <div class="jobPage__btnBox mb-lg-4 mb-0">
            <router-link
              class="btn btn-primary mb-lg-3 mb-0"
              aria-current="page"
            ...
            <button
              type="button"
              class="btn btn-gray-light me-lg-0 me-2"
              @click="collectJob(jobItem)"
              :class="{ 'text-secondary': jobIsCollect }"
            >
              {{ jobIsCollect ? '已收藏職位' : '收藏職位' }}
            </button>
          </div>
          <div
            v-if="jobItem.options.company.companyImagesUrl.length > 0"
            class="jobSideBox box--shadow mb-3"
          >
          ...
          <div class="rwdSideModal" :class="{ active: historyOpen }">
            <JobReadRecord />
          </div>
        </div>
      </div>
  ...
  <div class="sideBtnBox SideBtnBox--page">
    <UpTopBtn />
    <button type="button" class="sideBtn btn btn-light mt-2" @click="historyOpen = !historyOpen">
